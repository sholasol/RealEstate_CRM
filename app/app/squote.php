...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header">
            <div>
                <h2 class="hk-pg-title font-weight-600">Sales Quote</h2>
            </div>
            <div class="d-flex mb-0 flex-wrap">
               <!-- <div class="btn-group btn-group-sm btn-group-rounded mb-15 mr-15" role="group">
                ...
                <?php
                  echo"
                <a href='asquote' class='btn btn-sm btn-outline-secondary btn-rounded btn-wth-icon icon-wthot-bg mb-15'><span class='icon-label'><span class='feather-icon'><i data-feather='plus'></i></span> </span><span class='btn-text'>New Quote</span></a>";
                               ...
                               <table id="datable_1" class="table table-hover w-100 display pb-30">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $q=  dbConnect()->prepare("SELECT sum(amount) AS amount, custID  AS cust, created, code, quote_no FROM squote WHERE branch='$branch' GROUP BY code ORDER BY id DESC");
                                        $q->execute();
                                        $counter =0;
                                        while($ro=$q->fetch()){
                                            $u=$ro['cust'];
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                    $it=  dbConnect()->prepare("SELECT item FROM squote WHERE code ='$cd'");
                                                    $it->execute();
                                                    while($r=$it->fetch()){
                                                        $itm=$r['item'];
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="dropdown">
                                                            ...
                                                            <div role="menu" class="dropdown-menu">
                                                                <a class="dropdown-item" href="squote_view?order=<?php echo $order; ?>">View Quote</a>
                                                                <?php 
                                                                $ch=  dbConnect()->prepare("SELECT count(id) AS id FROM squote WHERE quote_no='$order'");
                                                                $ch->execute();
                                                                $rr = $ch->fetch();
                                                                $no=$rr['id'];
                                                                /*
                                                                if($no > 0){
                                                                    echo "<a class='dropdown-item' href='squote_view?order=$order'>View Quote</a>";
                                                                }else{
