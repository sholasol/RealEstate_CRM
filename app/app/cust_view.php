...
if(isset($_POST['save'])){
    ...
    elseif(empty($_POST['type'])){
        ...
        $user = $uid;
            ...
            $in=dbConnect()->prepare("UPDATE customer SET type=:typ, fname=:fn, lname=:ln, phone=:ph, email=:em, web=:web, company=:comp, address=:add, modified=:dt, modifyby=:by WHERE custID=:cust ");
            $in->bindParam(':fn', $fn);
            $in->bindParam(':ln', $ln);
            $in->bindParam(':em', $em);
            $in->bindParam(':ph', $ph);
