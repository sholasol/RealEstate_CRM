                                         ...
                                         <table class="table table-striped table-border mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="bg-transparent">
                                                    ...
                                                    <td class="text-right border-top-0">=N= <?php echo number_format($tx); ?></td>
                                                </tr>
                                            </tbody>
                                            <tfoot class="border-bottom border-1">
                                                <tr>
                                                    <th colspan="4" class="text-right font-weight-600">total</th>
                                                    <th class="text-right font-weight-600">=N= <?php echo number_format($totl); ?></th>
                                                </tr>
                                            </tfoot>
                                        </table><br/><hr/>
                                <div class="table-wrap">
                                   <button type="submit" name="save" class="btn btn-primary btn-sm pull-right">Save Invoice</button>
                                </div>
                                    </div>
                                </div>
                            </div><br/><br/>
