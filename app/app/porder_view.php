...
$jb=  dbConnect()->prepare("SELECT * FROM porder WHERE order_no='$order'");
$jb->execute();
$jj=$jb->fetch();
$cid = $jj['venID'];
$slp = $jj['salesperson'];
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="sorder">Sale Order</a></li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header mb-10">
                    <div>
                            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="book"></i></span></span>Sales Order</h4>
                    </div>
		   <div class="d-flex">
                                        ...
                                        <table class="table table-striped table-border mb-0">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $tx=0;
                                                    $gtotal=0;
                                                    $jbb=  dbConnect()->prepare("SELECT * FROM porder WHERE order_no='$order'");
                                                    $counter = 0;
                                                    $jbb->execute();
                                                    while($b=$jbb->fetch()){
                                                        $t=$b['amount'];
                                         ...
                                         <table class="table table-striped table-border mb-0">
                                            ...
                                            <tbody>
                                                <tr class="bg-transparent">
                                                    ...
                                                    <td class="text-right">=N= <?php echo number_format($tt); ?></td>
                                                </tr>
                                                <tr class="bg-transparent">
                                                    <td colspan="6" class="text-right text-light border-top-0">Tax</td>
                                                    <td class="text-right border-top-0">=N= <?php echo number_format($tx, $decimal =2); ?></td>
                                                </tr>
                                            </tbody>
                                            <tfoot class="border-bottom border-1">
                                                <tr>
                                                    <th colspan="6" class="text-right font-weight-600">total</th>
                                                    <th class="text-right font-weight-600">=N= <?php echo number_format($gtotal, $decimal =2); ?></th>
                                                </tr>
                                            </tfoot>
                                        </table><br/>
                                    </div>
