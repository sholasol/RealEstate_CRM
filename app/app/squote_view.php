...
$jb=  dbConnect()->prepare("SELECT * FROM squote WHERE quote_no='$order'");
$jb->execute();
$jj=$jb->fetch();
$cid = $jj['custID'];
$slp = $jj['salesperson'];
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header mb-10">
                    <div>
                            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="book"></i></span></span>Sales Quote</h4>
                    </div>
		   <div class="d-flex">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-border mb-0">
                                            ...
                                            <tbody>
                                                <?php
                                                    $tt =0;
                                                    $jbb=  dbConnect()->prepare("SELECT * FROM squote WHERE quote_no='$order'");
                                                    $counter = 0;
                                                    $jbb->execute();
                                                    while($b=$jbb->fetch()){
                                                        $t=$b['total'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right"><?php echo number_format($b['tax'], $decimal =2); ?></td>
                                         ...
                                         <table class="table table-striped table-border mb-0">
                                            ...
                                            <tfoot class="border-bottom border-1">
                                                <tr>
                                                    ...
                                                    <th class="text-right font-weight-600">=N= <?php echo number_format($totl, $decimal = 2); ?></th>
                                                </tr>
                                            </tfoot>
                                        </table><br/>
                                    </div>
