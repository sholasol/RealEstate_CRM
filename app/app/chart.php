        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header">
                    <div>
			<h2 class="hk-pg-title font-weight-600">Chart Accounts</h2>
                    </div>
                    <div class="d-flex mb-0 flex-wrap">
                        <div class="btn-group btn-group-sm btn-group-rounded mb-15 mr-15" role="group">
                            <a href="saleA" class="btn btn-outline-secondary">Sales</a>
                            <a href="employeeA" class="btn btn-outline-secondary">Salary</a>
                            <a href="managementA" class="btn btn-outline-secondary">Management</a>
                            <a href="supplyA" class="btn btn-outline-secondary">Office Supply</a>
                            <a href="operationA" class="btn btn-outline-secondary">Operation</a>
                            <a href="pettyA" class="btn btn-outline-secondary">Petty Cash</a>
                        </div>
                    </div>
                </div>
                <!-- /Title -->
