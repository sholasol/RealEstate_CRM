...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header">
            <div>
                <h2 class="hk-pg-title font-weight-600">Previous Sales Record</h2>
            </div>
                               ...
                               <table id="datable_1" class="table table-hover w-100 display pb-30">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $q=  dbConnect()->prepare("SELECT  * FROM subscribers");
                                        $q->execute();
                                        $counter =0;
                                        while($ro=$q->fetch()){
                                            $bl = 0;
                                            ...
                                            $bl = $ro['amount_agreed'] - $x['amount'];
                                        ?>
                                        <tr>
                                                <td><?php echo ++$counter; ?></td>
                                                <td><a class="dropdown-item" href="sview?order=<?php  echo $sid; ?>"><?php echo $ro['firstname']." ".$ro['lastname']; ?><br><small><?php echo $ro['phone'];?></small></a></td>
                                                <td>
                                                ...
                                                <td><span class="badge badge-success"><?php echo number_format($paid); ?></span></td>
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="dropdown">
                                                            ...
                                                            <div role="menu" class="dropdown-menu">
                                                                <a class="dropdown-item" href="sview?order=<?php  echo $sid; ?>">View Sale</a>
                                                                <?php 
                                                                if($bl > 0){echo "<a class='dropdown-item' href='balance?order=$sid'>Pay Balance</a>";}
                                                                ...
                                                                ?>
                                                                <!--<a class="dropdown-item" href="saleInv?order=<?php echo $sid; ?>">Create Invoice</a>-->
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
