        ...
        echo  " <script>alert('$e'); ";
           ...
           $tot_pay = $paid + $pay;
                ...
                if($pay > $bal){
                 ...
                 $pym= dbConnect()->prepare("INSERT INTO payment SET  custID='$order', amount='$pay', datepaid='$dt', bank='$bank', confirmation='Yes', staff='$by', remark='$rmk' ");
                if($pym->execute()){
                       ...
                       if($balance > 0){
                           echo"
                            ...
                            <div style='width:100%;text-align:center;vertical-align:bottom'>
                                    ...
                                    <br>
                                    <meta http-equiv='refresh' content='2;url=osale'>
