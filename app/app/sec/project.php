<?php
        ...
        //number of projects
        $query= dbConnect()->prepare("SELECT * FROM project");
        $query->execute();
        $no = $query->rowCount();
        ...
        <div class="hk-pg-wrapper">
			...
			<h2 class="hk-pg-title font-weight-600">Our Products</h2>
                    ...
                    <div class="d-flex mb-0 flex-wrap">
                       <!-- <a href="aproject" class="btn btn-sm btn-outline-secondary btn-rounded btn-wth-icon icon-wthot-bg mb-15"><span class="icon-label"><span class="feather-icon"><i data-feather="home"></i></span> </span><span class="btn-text">New Project</span></a>-->
                    </div>
                </div>
                <!-- /Title -->
                        ...
                        <div class="hk-row">
                            <div class="col-lg-3 col-sm-6">
                                    <div class="card card-sm">
                                            <div class="card-body">
                                                    <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Projects Year till Date</span>
                   ...
                   <div class="hk-row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div id="area_chart2" class="echart" style="height:237px;"></div>
                                    </div>
                            </div>
                                </div>
                        </div>
                                            ...
                                            <div class="table-responsive">
                                                    <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td><span class="badge badge-info"><?php echo number_format($ro['cost']); ?></span></td>
                                                                <td><span class="badge badge-success"><?php echo number_format($ro['unit']); ?></span></td>
                                                                <td><?php echo $ro['start']; ?></td>
                                                                <td><span class="badge badge-info"><?php echo $ro['status']; ?></span></td>
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <div class="dropdown">
