                            ...
                            <div class="invoice-details">
                                ...
                                <div align="justify">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table  class="table table-hover w-100 display pb-30">
                                            <tr>
                                                <td width="80%">Deed of Assignment</td>
                                                <td width="20%">
                                                    <?php 
                                                    $qq=  dbConnect()->prepare("SELECT * FROM statutorypay WHERE custID='$cust' AND fee= 1 ");
                                                    $qq->execute();
                                                    $ra=$qq->fetch();
                                                        $amta = $ra['amount'];
                                                    if( $amta > 0){   echo '₦'. number_format($amta); } else{ echo 'Nil';}
                                                        //echo $amta;
                                                    ?>
                                                </td>
                                            ...
                                            <tr>
                                                <td width="80%">Survey Fee</td>
                                                <td width="20%">
                                                    <?php 
                                                    $qq=  dbConnect()->prepare("SELECT * FROM statutorypay WHERE custID='$cust' AND product='$itm' AND fee =2 ");
                                                    ...
                                                    if( $amtb > 0){  echo '₦'. number_format($amtb);;}
                                                    else{ echo 'Nil';}    
                                            ...
                                            <tr>
                                                <td width="80%">Development Fee</td>
                                                <td width="20%">
                                                    <?php 
                                                    $qq=  dbConnect()->prepare("SELECT * FROM statutorypay WHERE custID='$cust' AND product='$itm' AND fee =3 ");
                                                    
                                                    $qq->execute();
                                                    $rc=$qq->fetch();
                                                        $amtc = $rc['amount'];
                                                
                                                    if( $amtc > 0){  echo '₦'. number_format($amtc);;}
                                                    else{ echo 'Nil';}    
