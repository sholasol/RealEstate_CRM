...
$id = $_GET['id'];
/*
$qu=  dbConnect()->prepare("SELECT * FROM statutory WHERE id=:id");
$qu->bindParam(':id', $id);
$qu->execute();
$ru=$qu->fetch();
$pid =$ru['project'];
...
if(isset($_POST['save'])){
    ...
    elseif(empty($_POST['amt'])){
        ...
        $q=  dbConnect()->prepare("UPDATE statutory SET amount=:amt,  created=:dt, createdby=:by WHERE fees=:fee ");
        $q->bindParam(':fee', $fee);
        $q->bindParam(':amt', $amt);
        $q->bindParam(':dt', $dt);
        $q->bindParam(':by', $user);
        if($q->execute()){
            $in= dbConnect()->prepare("INSERT INTO activity SET userID='$uid', activity='Updating Statutory Fee Amount $amt for project ($project) by userID $uid', created=now()");
            $in->execute();
            ...
            echo"
                    ...
                    <div style='width:100%;text-align:center;vertical-align:bottom'>
                            ...
                            <br>
                            <meta http-equiv='refresh' content='1;url=statutory_edit?id=$id'>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
                        <h4 class="hk-pg-title font-weight-600 mb-10">Update Statutory Fees</h4>
                    </div>
                </div>
                <!-- /Title -->
