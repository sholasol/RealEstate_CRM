...
$qq=dbConnect()->prepare("SELECT sum(tax_value) AS tt, sum(total) AS totl, count(item) AS item FROM porder GROUP by order_no");
$qq->execute();
$po=$qq->rowCount();
while($ro = $qq->fetch()){
$tax = $ro['tt'];
...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header">
            <div>
                <h2 class="hk-pg-title font-weight-600">Purchase Invoice</h2>
            </div>
                               ...
                               <table id="datable_1" class="table table-hover w-100 display pb-30">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $q=  dbConnect()->prepare("SELECT sum(amount) AS amount, venID  AS cust, created, code, order_no FROM porder WHERE branch='$branch' GROUP BY code ORDER BY id DESC");
                                        $q->execute();
                                        $counter =0;
                                        while($ro=$q->fetch()){
                                            $u=$ro['cust'];
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="dropdown">
                                                            ...
                                                            <div role="menu" class="dropdown-menu">
                                                                <a class="dropdown-item" href="purInv_view?order=<?php echo $order; ?>">View Invoice</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
