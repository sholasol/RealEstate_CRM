...
$qq=  dbConnect()->prepare("SELECT sum(amount) AS amount, sum(qty) AS plots, sum(paid) AS paid, sum(balance) AS bal, sum(consultAmt) AS consult FROM sorder WHERE branch='$branch' AND YEAR(created)= Year(CURRENT_DATE()) ");
$qq->execute();
$ro=$qq->fetch();
...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header">
            <div>
                <h2 class="hk-pg-title font-weight-600">Income Report</h2>
            </div>
                ...
                <div class="hk-row">
                    <div class="col-lg-3 col-sm-6">
                            <div class="card card-sm">
                                    <div class="card-body">
                                            <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Expected Income</span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                            <div class="card card-sm">
                                    <div class="card-body">
                                            <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Actual Income </span>
                                            <div class="d-flex align-items-center justify-content-between position-relative">
                                                    <div>
                                                            <span class="d-block">
                    ...
                    <div class="col-lg-3 col-sm-6">
                            <div class="card card-sm">
                                    <div class="card-body">
                                            <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Consultancy</span>
                                            <div class="d-flex align-items-end justify-content-between">
                                                    <div>
                                                            <span class="d-block">
                                                                    <span class="display-5 font-weight-400 text-dark"><?php echo number_format($consult) ;?></span>
                                                            </span>
                                                    </div>
                                            </div>
                                    </div>
                               ...
                               <table id="datable_1" class="table table-hover w-100 display pb-30">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $q=  dbConnect()->prepare("SELECT sum(amount) AS amount,sum(balance)  AS balance, custID  AS cust, item, qty, paid, balance, created, code, order_no, kfn, kln FROM sorder WHERE branch='$branch' GROUP BY code ORDER BY id DESC");
                                        $q->execute();
                                        $counter =0;
                                        while($ro=$q->fetch()){
                                            $u=$ro['cust'];
                                        ...
                                        <tr>
                                                ...
                                                <td><span class="badge badge-light"><?php echo number_format($ro['qty'])." Plots"; ?></span></td>
                                                <td><span class="badge badge-light"><?php echo number_format($ro['amount']); ?></span></td>
