	...
	<div class="hk-wrapper hk-horizontal-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="index">
                <img class="brand-img d-inline-block" src="../dist/img/logoa.png" alt="brand" />
            </a>
            <ul class="navbar-nav hk-navbar-content">
                ...
                <li class="nav-item dropdown dropdown-notifications">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="feather-icon coll"><i data-feather="bell"></i></span><span class="badge-wrap"><span class="badge badge-brown badge-indicator badge-indicator-sm badge-pill pulse coll"></span></span></a>
...
<!--                                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="user_drp" class="nav flex-column collapse collapse-level-1">           
                                <li class="nav-item">
                                    <a class="nav-link" href="sorder">Sale Transactions</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="charts_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="income">Income Report</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="activity">Activities Reports</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
