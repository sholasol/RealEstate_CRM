        ...
        <div class="hk-pg-wrapper">
			...
			<h2 class="hk-pg-title font-weight-600">Chart Accounts</h2>
                    ...
                    <div class="d-flex mb-0 flex-wrap">
                        ...
                        <a href="achart" class="btn btn-sm btn-outline-secondary btn-rounded btn-wth-icon icon-wthot-bg mb-15"><span class="icon-label"><span class="feather-icon"><i data-feather="plus"></i></span> </span><span class="btn-text">New Chart of Account</span></a>
                    </div>
                </div>
                <!-- /Title -->
