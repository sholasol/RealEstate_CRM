...
//Total Employee
$ep=  dbConnect()->prepare("SELECT count(userID) as count FROM employee WHERE branch='$branch' ");
$ep->execute();
$r=$ep->fetch();
...
//Confirmed Employee
$q1=  dbConnect()->prepare("SELECT count(userID) as count FROM employee WHERE status='Active' and branch='$branch'");
$q1->execute();
$rr=$q1->fetch();
$confirm=$rr['count'];

//Employees that exits the company
$q2=  dbConnect()->prepare("SELECT count(userID) as count FROM employee WHERE branch='$branch' AND status='Exit'");
$q2->execute();
$rr2=$q2->fetch();
$exit=$rr2['count'];

//Employeee pending confirmation
$q3=  dbConnect()->prepare("SELECT count(userID) as count FROM employee WHERE branch='$branch' AND status='Pending'");
$q3->execute();
$rr3=$q3->fetch();
$pending=$rr3['count'];
                        ...
                        <div class="hk-row">
                            <div class="col-lg-3 col-sm-6">
                                    <div class="card card-sm">
                                            <div class="card-body">
                                                    <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Total Employees</span>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                    <div class="card card-sm">
                                            <div class="card-body">
                                                    <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Confirmed</span>
                                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                                            <div>
                                                                    <span class="d-block">
                                                                        <span class="display-5 font-weight-400 text-dark"><span class="counter-anim"><?php echo number_format($confirm); ?></span></span>
                                                                    </span>
                                                            </div>
                                                    </div>
                                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                    <div class="card card-sm">
                                            <div class="card-body">
                                                    <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Exit</span>
                                                    <div class="d-flex align-items-end justify-content-between">
                                                            <div>
                                                                    <span class="d-block">
                                                                            <span class="display-5 font-weight-400 text-dark"><?php echo number_format($exit); ?></span>
                                                                    </span>
                                                            </div>
                                                    </div>
                                            </div>
			...
			series: [
				{
					...
					data:[
						...
						{value:<?php echo $confirm; ?>, name:'Approved'},
						{value:<?php echo $pending; ?>, name:'Pending'},
                                                {value:<?php echo $exit; ?>, name:'Exit'}
					],
					label: {
						normal: {
							formatter: '{b}\n{d}%'
