        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
                        <h4 class="hk-pg-title font-weight-600 mb-10"><i class="ion ion-ios-calendar"></i> Salary Schedule for month of <?php echo date('F');?></h4>
                    </div>
                </div>
                <!-- /Title -->
                               ...
                               <table id="datable_1" class="table table-hover w-100 display pb-30">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $q=  dbConnect()->prepare("SELECT * FROM emp_pay WHERE month='$dd' AND year='$yr'");
                                        $q->execute();
                                        $counter =0;
                                        while($ro=$q->fetch()){
                                            $gr=$ro['grade'];
