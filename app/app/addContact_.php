...
if(isset($_POST['save'])){
    ...
    elseif(empty($_POST['type'])){
        ...
        if($no < 1){
            ...
            $in=dbConnect()->prepare("INSERT INTO customer SET type=:typ, fname=:fn, lname=:ln, phone=:ph, email=:em, web=:web, company=:comp, address=:add, created=:dt, createdby=:by, branch=:brn ");
            $in->bindParam(':fn', $fn);
            $in->bindParam(':ln', $ln);
            $in->bindParam(':em', $em);
            $in->bindParam(':ph', $ph);
            ...
            echo"
                    ...
                    <div style='width:100%;text-align:center;vertical-align:bottom'>
                            ...
                            <br>
                            <meta http-equiv='refresh' content='1;url=contact'>
                            <span class='itext' style='color: blueviolet;'>This customer already exist...</span>
                    </div><br><br><br><br><br><br><br><br>";
