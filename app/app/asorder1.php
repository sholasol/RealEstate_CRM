...
if(isset($_POST['save'])){
        ...
        echo  " <script>alert('$e'); ";
           ...
           foreach ($_POST['item'] as $item => $value){
               ...
               $pr= dbConnect()->prepare("INSERT INTO sorder SET custID=:cust, order_no=:inv, item=:item, qty=:qty, price=:pr, amount=:amt, tax=:tax, tax_value=:tx, total=:tot, salesperson=:sl, code=:code, created=:dt, createdby=:by, branch=:brn");
