...
$jb=  dbConnect()->prepare("SELECT * FROM pquote WHERE quote_no='$order'");
$jb->execute();
$jj=$jb->fetch();
$cid = $jj['venID'];
//$slp = $jj['salesperson'];
...
$j=  dbConnect()->prepare("SELECT * FROM vendor WHERE id='$cid'");
$j->execute();
$jr=$j->fetch();
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header mb-10">
                    <div>
                            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="book"></i></span></span>Purchase Quote</h4>
                    </div>
		   <div class="d-flex">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-20">
                                        <div class="col-md-12 mb-10">
                                            <label for="validationCustom01">Vendor </label>
                                ...
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-border mb-0">
                                            ...
                                            <tbody>
                                                <?php
                                                    $tt =0; //total amount without tax
                                                    $to=0; //total
                                                    $ta = 0; //tax value initialization
                                                    $jbb=  dbConnect()->prepare("SELECT * FROM pquote WHERE quote_no='$order'");
                                                    $counter = 0;
                                                    $jbb->execute();
                                                    while($b=$jbb->fetch()){
                                                        $t=$b['amount'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right"><?php echo number_format($b['tax_value']); ?></td>
                                                    <td class="text-right"><?php echo number_format($b['total']); ?></td>
                                                </tr>
                                                    <?php } ?>
                                            </tbody>
                                        </table>
                                         ...
                                         <table class="table table-striped table-border mb-0">
                                            <tbody>
                                                <tr class="bg-transparent">
                                                    ...
                                                    <td class="text-right">=N= <?php echo number_format($tt, $decimal = 2); ?></td>
                                                </tr>
                                                <tr class="bg-transparent">
                                            ...
                                            <tfoot class="border-bottom border-1">
                                                <tr>
                                                    ...
                                                    <th class="text-right font-weight-600">=N= <?php echo number_format($to, $decimal = 2); ?></th>
                                                </tr>
                                            </tfoot>
                                        </table><br/>
                                    </div>
