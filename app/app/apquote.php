...
if(isset($_POST['save'])){
        ...
        echo  " <script>alert('$e'); ";
           ...
           foreach ($_POST['item'] as $item => $value){
               ...
               $pr= dbConnect()->prepare("INSERT INTO pquote SET venID=:ven, quote_no=:inv, item=:item, qty=:qty, price=:pr, amount=:amt,tax=:tax, tax_value=:tx, total=:tot, code=:code, created=:dt, createdby=:by, branch=:brn");
               $pr->bindParam(':ven', $ven);
           ...
           if($pr){
               ...
               $inx= dbConnect()->prepare("INSERT INTO activity SET userID='$uid', activity='Creation of Purchase Quote with invoice number $invoice by userID with ID of $uid', created=now()");
                    $inx->execute();
                    ...
                    <div style='width:100%;text-align:center;vertical-align:bottom'>
                            ...
                            <br>
                            <meta http-equiv='refresh' content='2;url=pquote_view?order=$invoice'>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="pquote">Purchase Quote</a></li>
                    ...
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper hk-invoice-wrap pa-35">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-20">
                                        <div class="col-md-12 mb-10">
                                            <label for="validationCustom01">Vendor <small><a href="addContact">Add</a></small></label>
                                            <select class="form-control select2" name="vendor" id="customer" required>
                                                <option value="">Select</option>
                                                    <?php
                                                    $jb=  dbConnect()->prepare("SELECT * FROM vendor WHERE branch='$branch'");
                                                    $jb->execute();
                                                    while($r=$jb->fetch()){
                                                        $compn=$r['company'];
                                                    ?>
                            ...
                            <div class="invoice-details">
                                      ...
                                      <td>
                                         <div class="cont">
                                             <div class="row">
                                                 ...
                                                 <input type="number" name="tax[]" class="form-control col-md-2" placeholder="Tax" /> &nbsp;&nbsp;&nbsp;
                                ...
                                <div class="table-wrap">
                                   <button type="submit" name="save" class="btn btn-primary btn-sm pull-right">Process Quote</button>
                                </div>
                            </div><br/>
                        </section>
                    </div>
