    ...
    /*
        ...
        echo  " <script>alert('$e'); ";
           ...
           foreach ($_POST['item'] as $item => $value){
               ...
               $pr= dbConnect()->prepare("INSERT INTO sinvoice SET custID=:cust, order_no=:inv, item=:item, qty=:qty, price=:pr, amount=:amt, salesperson=:sl, code=:code, created=:dt, createdby=:by, branch=:brn");
           ...
           if($pr){
               ...
               $inx= dbConnect()->prepare("INSERT INTO activity SET userID='$uid', activity='Creation of sales invoice with order number $invoice by userID with ID of $uid', created=now()");
                    $inx->execute();
                                    ...
                                    <div class="col-md-4 mb-20">
                                        <div class="col-md-12 mb-10">
                                            ...
                                            <select class="form-control select2" name="customer" id="customer" disabled>
                                                <option value="<?php echo $cid ?>"><?php echo $custo ?></option>
                                            </select>
                                        </div>
                                        <div class="col-md-12 mb-10">
                                    ...
                                    <div class="col-md-4 mb-20"><br>
                                       ...
                                       <div class="col-md-12 mb-10">
                                            <select class="form-control select2" name="person" disabled>
                                                <option value="<?php echo $slp; ?>"><?php echo $saleP; ?></option>
                                            </select>
                                            <div class="valid-feedback"> Looks good! </div> <div class="invalid-feedback"> Error </div>
                                        </div>
                                    </div>
