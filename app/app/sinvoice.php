...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header">
            <div>
                <h2 class="hk-pg-title font-weight-600">Sales Invoice</h2>
            </div>
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="dropdown">
                                                            ...
                                                            <div role="menu" class="dropdown-menu">
                                                                <a class="dropdown-item" href="cust_payment?order=<?php echo $order; ?>">Process Payment</a>
                                                                <a class="dropdown-item" href="saleInv_view?order=<?php echo $order; ?>">View Sale Invoice</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
