...
$qq=dbConnect()->prepare("SELECT sum(tax_value) AS tt, sum(total) AS totl, count(item) AS item FROM pquote GROUP by quote_no");
$qq->execute();
$po=$qq->rowCount();
while($ro = $qq->fetch()){
$tax = $ro['tt'];
...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header">
            <div>
                <h2 class="hk-pg-title font-weight-600">Purchase Quote <?php echo $tax; ?></h2>
            </div>
            <div class="d-flex mb-0 flex-wrap">
               <!-- <div class="btn-group btn-group-sm btn-group-rounded mb-15 mr-15" role="group">
                ...
                <?php
                  echo"
                <a href='apquote' class='btn btn-sm btn-outline-secondary btn-rounded btn-wth-icon icon-wthot-bg mb-15'><span class='icon-label'><span class='feather-icon'><i data-feather='plus'></i></span> </span><span class='btn-text'>New Quote</span></a>";
                ...
                <div class="hk-row">
                    <div class="col-lg-3 col-sm-6">
                            <div class="card card-sm">
                                    <div class="card-body">
                                            <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Purchase quote</span>
                                            <div class="d-flex align-items-center justify-content-between position-relative">
                                                    <div>
                                                        <span class="d-block display-5 font-weight-400 text-dark"><?php echo number_format($po) ;?></span>
                                                    </div>
                            ...
                            <div class="card card-sm">
                                    <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between">
                                                    <div>
                                                            <span class="d-block">
                                                                    <span class="display-5 font-weight-400 text-dark">=N= <?php echo number_format($tax, $decimal=2) ;?></span>
                            ...
                            <div class="card card-sm">
                                    <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between position-relative">
                                                    <div>
                                                            <span class="d-block">
                                                                    <span class="display-5 font-weight-400 text-dark">=N=<span class="counter-anim"><?php echo number_format($tot, $decimal=2) ;?></span></span>
                                                            </span>
                                                    </div>
                                            </div>
                                    </div>
                            ...
                            <div class="card card-sm">
                                    <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between">
                                                    <div>
                                                            <span class="d-block">
                                                                <span class="display-5 font-weight-400 text-dark"><?php echo number_format($item) ;?></span>
                                                            </span>
                                                    </div>
                                            </div>
                                    </div>
                               ...
                               <table id="datable_1" class="table table-hover w-100 display pb-30">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $q=  dbConnect()->prepare("SELECT sum(amount) AS amount, venID  AS cust, created, code, quote_no FROM pquote WHERE branch='$branch' GROUP BY code ORDER BY id DESC");
                                        $q->execute();
                                        $counter =0;
                                        while($ro=$q->fetch()){
                                            $u=$ro['cust'];
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                    $it=  dbConnect()->prepare("SELECT item FROM pquote WHERE code ='$cd'");
                                                    $it->execute();
                                                    while($r=$it->fetch()){
                                                        $itm=$r['item'];
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="dropdown">
                                                            ...
                                                            <div role="menu" class="dropdown-menu">
                                                                <a class="dropdown-item" href="pquote_view?order=<?php echo $order; ?>">View Quote</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
