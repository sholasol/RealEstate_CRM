           ...
           if($paid > ($qty*$cost)){
            ...
            if($pr){
               ...
               if($bk->execute()){
                   ...
                   $pym= dbConnect()->prepare("INSERT INTO payment SET order_no='$invoice', custID='$cust', amount='$paid', datepaid='$dtt', bank='$bank', confirmation='Yes', staff='$by', remark='$remark' ");
                   $pym->execute();
            ...
            <div class="container">
                ...
                <div class="col-sm">
                    <form class="needs-validation" method="POST" novalidate>
                        <div class="col-xl-12 mb-20">
                               <h3>
                                    ...
                                    <span class="wizard-head-text-wrap">
                                            ...
                                            <span class="col-md-4 btn btn-gradient-success"><small><a data-toggle="modal" data-target="#exampleModalLarge01"> Create  New Customer <i data-feather="user"></i></a></small></span>
                                            <span class="col-md-4 btn btn-blue"><small><a data-toggle="modal" data-target="#exampleModalLarge00"> Create New Consultant <i data-feather="users"></i></a></small></span>
                                    </span>	
                                </h3>
                            <hr/>
                                <div class="row">
                        ...
                        <h3>
                            <span class="wizard-icon-wrap"><i data-feather="user"></i></span>
                            <span class="wizard-head-text-wrap">
                                    <span class="step-head">Property Information</span>
                            </span>	
                        </h3><hr/>
                        <div class="col-xl-12 mb-20">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="land" class="form-control select2 d-block w-100" id="land" required>
                                            ...
                                            <?php
                                            $jb=  dbConnect()->prepare("SELECT * FROM estates");
                                            $jb->execute();
                                            while($r=$jb->fetch()){
                                            ?>
                                            <option><?php echo $r['estate_name'];?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="valid-feedback"> Looks good! </div> <div class="invalid-feedback"> Error </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="job">No. of Units</label>
                                ...
                                <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="typ">Property Type</label>
                                    <select name="type" class="form-control select2 d-block w-100" id="type" required>
                                            <option value="">Choose Type...</option>
                                            <option>1 Bedroom Apartment</option>
                                            <option>2 Bedroom Apartments</option>
                                            <option>3 Bedroom Apartments</option>
                                            <option>2 Bedroom Duplex + BQ</option>
                        ...
                        <h3>
                            <span class="wizard-icon-wrap"><i data-feather="book"></i></span>
                            <span class="wizard-head-text-wrap">
                        ...
                        <div class="col-xl-12 mb-20">
                                ...
                                <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <select name="rel" class="form-control select2 d-block w-100" id="type" >
