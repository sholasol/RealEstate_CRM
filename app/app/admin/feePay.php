...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header">
            <div>
                <h2 class="hk-pg-title font-weight-600">Statutory Payments Paid</h2>
            </div>
    ...
    <div class="d-flex align-items-center justify-content-between mt-40 mb-20">
        <h4>Paid Fees </h4>  <small><a class="btn btn-default" href="statutory">Back</a></small>
    </div>
    <div class="card">
...
<!--                                        <th width="10%">Action</th>-->
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $q=  dbConnect()->prepare("
                                            SELECT statutorypay.custID, statutorypay.amount, statutorypay.product, statutorypay.created, fees.fee
                                            FROM statutorypay, fees WHERE statutorypay.fee = fees.id 
                                                ");
                                        $q->execute();
                                        $counter =0;
                                        while($ro=$q->fetch()){
                                            ...
                                            $cs=  dbConnect()->prepare("SELECT fname, lname, phone FROM customer WHERE custID='$cid'");
                                            $cs->execute();
                                            $rq=$cs->fetch();
