...
$jb=  dbConnect()->prepare("SELECT * FROM pinvoice WHERE order_no='$order'");
$jb->execute();
$jj=$jb->fetch();
$cid = $jj['venID'];
//$slp = $jj['salesperson'];
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="porder">Purchase Order</a></li>
                                        ...
                                        <table class="table table-striped table-border mb-0">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $ta = 0;
                                                    $am = 0;
                                                    $jbb=  dbConnect()->prepare("SELECT * FROM pinvoice WHERE order_no='$order'");
                                                    $counter = 0;
                                                    $jbb->execute();
                                                    while($b=$jbb->fetch()){
                                                        $amt =$b['amount'];
