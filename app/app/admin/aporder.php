...
if(isset($_POST['save'])){
        ...
        echo  " <script>alert('$e'); ";
           ...
           foreach ($_POST['item'] as $item => $value){
               ...
               $pr= dbConnect()->prepare("INSERT INTO porder SET venID=:cust, order_no=:inv, item=:item, qty=:qty, price=:pr, amount=:amt, tax=:tax, tax_value=:tx, total=:tot, code=:code, created=:dt, createdby=:by, branch=:brn");
           ...
           if($pr){
               ...
               $inx= dbConnect()->prepare("INSERT INTO activity SET userID='$uid', activity='Creation of Purchase Quote with order number $invoice by userID with ID of $uid', created=now()");
                    $inx->execute();
                    ...
                    <div style='width:100%;text-align:center;vertical-align:bottom'>
                            ...
                            <br>
                            <meta http-equiv='refresh' content='1;url=porder_view?order=$invoice'>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="porder">Purchase Orders</a></li>
                                  ...
                                  <table id="mytable" width="100%">
                                    <tr>
                                      <td>
                                         ...
                                         <a href="" class="add_fields pull-right"><i class="fa fa-plus"></i> Add New</a>
                                      </td>
                                    </tr>
                                  </table>
                                </div><br/><hr/>
                ...
                var y =max_fields + 1;
                    ...
                    if(x < max_fields){ 
                        ...
                        $(cont).append('<div class="cont"><br>\n\
                           ...
                           </div><a href="javascript:void(0);" class="remove_field pull-right" style="color: red;"><i class="fa fa-trash"> Remove</i></a> \n\
                            \n\
                        </div>');
