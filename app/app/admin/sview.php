                                ...
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-border mb-0">
                                            <thead>
                                                <tr>
                                                    <th class="w-30">Payment Date</th>
                                                    <th class="w-30">Property</th>
                                                    <th class="w-20">No. of Units</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="w-30"><?php echo $rx['datepaid']; ?></td>
                                                    <td class="w-30"><?php echo  $ro['item'] ?><br><small><?php echo $ro['type'] ?></small></td>
                                                     <td class="w-30"><?php echo $ro['qty'].' Unit(s)'; ?></td>
                                            ...
                                            <tfoot class="border-bottom border-1">
                                                <tr>
                                                    ...
                                                    <th colspan="4" class="text-right font-weight-600">Total Paid:</th>
