                        ...
                        <div class="col-xl-12 mb-20">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" value="<?php echo number_format($unit); ?>" class="form-control" disabled>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="job">Amount Due</label>
                                        <input type="text" value="<?php echo number_format($amt); ?>" class="form-control" disabled>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="job">Amount Paid</label>
                                        <input type="text" value="<?php echo number_format($paid); ?>" class="form-control" disabled>
                                    </div>
                                    <div class="form-group col-md-4">
