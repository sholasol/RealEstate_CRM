...
if(isset($_POST['save'])){
        ...
        echo  " <script>alert('$e'); ";
           ...
           foreach ($_POST['item'] as $item => $value){
               ...
               $pr= dbConnect()->prepare("INSERT INTO squote SET custID=:cust, quote_no=:inv, item=:item, qty=:qty, price=:pr, amount=:amt, tax=:tax, total=:tot, salesperson=:sl, code=:code, created=:dt, createdby=:by, branch=:brn");
           ...
           if($pr){
               ...
               $inx= dbConnect()->prepare("INSERT INTO activity SET userID='$uid', activity='Creation of sales quote with quote number $invoice by userID with ID of $uid', created=now()");
                    $inx->execute();
                    ...
                    <div style='width:100%;text-align:center;vertical-align:bottom'>
                            ...
                            <br>
                            <meta http-equiv='refresh' content='2;url=squote_view?order=$invoice'>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="squote">Sale Quote</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Sale Quote</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header mb-10">
                    <div>
                            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="book"></i></span></span>Sale Quote</h4>
                    </div>
		   <div class="d-flex">
