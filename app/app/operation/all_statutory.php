...
<div class="hk-pg-wrapper">
    ...
    <div class="d-flex align-items-center justify-content-between mt-40 mb-20">
        <h4>All Statutory Fee </h4>  <small><a class="btn btn-default" href="statutory">Back</a></small>
    </div>
    <div class="card">
...
<!--                                        <th width="10%">Action</th>-->
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $q=  dbConnect()->prepare("
                                            SELECT statutory.project, statutory.amount, statutory.created, fees.fee,
                                            project.project, project.id FROM statutory, fees, project WHERE statutory.fees = fees.id 
                                            AND statutory.project = project.id 
                                                ");
                                        $q->execute();
                                        $counter =0;
                                        while($ro=$q->fetch()){
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="dropdown">
                                                            ...
                                                            <div role="menu" class="dropdown-menu">
                                                                <?php 
                                                                echo "<a class='dropdown-item' href='statutory_edit?id=$id'>View Fees</a>";
                                                                ?>
                                                            </div>
                                                        </div>
                                                    </div>
