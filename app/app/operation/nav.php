                    ...
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link link-with-badge" href="javascript:void(0);" data-toggle="collapse" data-target="#app_drp">
                                ...
                                <span class="badge badge-brown badge-pill"><i class="icon icon-user"></i></span>
                            </a>
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="charts_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="employeeR">Employees Report</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="salary">Salary Report</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="leaveR">Leave Report</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="travelR">Travel Report</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="attendanceR">Attendance Report</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
