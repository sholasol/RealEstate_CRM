...
if(isset($_POST['save'])){
    ...
    elseif(empty($_POST['type'])){
        ...
        $user = $uid;
            ...
            $in=dbConnect()->prepare("UPDATE customer SET type=:typ, fname=:fn, lname=:ln, phone=:ph, email=:em, state=:web, occupation=:comp, address=:add, modified=:dt, modifyby=:by WHERE custID=:cust ");
            $in->bindParam(':fn', $fn);
            $in->bindParam(':ln', $ln);
            $in->bindParam(':em', $em);
            $in->bindParam(':ph', $ph);
            ...
            if($in->execute()){
                ...
                $inx= dbConnect()->prepare("INSERT INTO activity SET userID='$uid', activity='Modification of customer profile $fn, $ln  by userID with ID of $uid', created=now()");
                    $inx->execute();
                    ...
                    <div style='width:100%;text-align:center;vertical-align:bottom'>
                            ...
                            <span class='itext' style='color: blueviolet;'>Updating Customer. Please Wait...</span>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
                        <h2 class="hk-pg-title font-weight-600 mb-10"> Customer</h2>
                    </div>
                </div>
                <!-- /Title -->
                                         ...
                                         <div class="col-xl-12 mb-20">
                                                    <h3>
                                                         ...
                                                         <span class="wizard-head-text-wrap">
                                                                 <span class="step-head"><?php echo $rw['fname'].", ".$rw['lname']; ?></span>
                                                         </span>	
                                                     </h3><hr/>
                                                     <div class="row">
                                                     ...
                                                     <div class="row">
                                                         ...
                                                         <div class="col-md-6 mb-10">
                                                             ...
                                                             <div class="input-group">
                                                                 ...
                                                                 <input class="form-control" name="comp" value="<?php echo $rw['occupation']; ?>" type="text"  />
                                                             </div>
                                                             <div class="valid-feedback"> Looks good! </div> <div class="invalid-feedback"> Error </div>
                                                         </div>
                                                     </div>
                                                         <div class="row">
                                                            ...
                                                            <div class="form-group col-lg-6">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" id="email" name="web" value="<?php echo $rw['state']; ?>"  type="text" >
                                                                </div>
                                                                <div class="valid-feedback"> Looks good! </div> <div class="invalid-feedback"> Error </div>
                                                            </div>
