...
if(isset($_POST['save'])){
        ...
        echo  " <script>alert('$e'); ";
           ...
           foreach ($_POST['item'] as $item => $value){
               ...
               $pr= dbConnect()->prepare("INSERT INTO pinvoice SET venID=:ven, order_no=:ord, item=:item, qty=:qty, price=:pr, amount=:amt, total=:tot, tax=:tax, tax_value=:val,  code=:code, created=:dt, createdby=:by, branch=:brn");
               $pr->bindParam(':ven', $cust);
               $pr->bindParam(':ord', $invoice);
           ...
           if($pr){
               ...
               $inx= dbConnect()->prepare("INSERT INTO activity SET userID='$uid', activity='Creation of purchaser order invoice with invoice number $invoice by userID with ID of $uid', created=now()");
                    $inx->execute();
                    ...
                    <div style='width:100%;text-align:center;vertical-align:bottom'>
                            ...
                            <br>
                            <meta http-equiv='refresh' content='2;url=purInv_view?order=$invoice'>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="pinvoice">Sale Invoice </a></li>
